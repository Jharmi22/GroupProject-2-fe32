...
const Products = () => {
    ...
    useEffect(() => {
        ...
        const getProducts = async () => {
            ...
            const response = await fetch("https://63517f85dfe45bbd55c1db19.mockapi.io/Obat-obatan");
            if (componentMounted) {
                            ...
                            <>
                                <div className="card" key={product.id}>
                                    ...
                                    <div className="card-body">
                                        <h3 className="title">{product.nama.substring(0, 20)}</h3>
                                        <div className="other">
        ...
        <div className='products'>
            <div className="container">
                <div className="row rowTitle">
                    <div className="col">
                        <h2 className='title'>Daftar Obat</h2>
                        <hr />
                    </div>
                </div>
